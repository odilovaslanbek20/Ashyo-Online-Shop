	...
	return (
		<section className='w-full bg-[#F3F0F0]'>
			<div className='max-w-[1180px] mx-auto max-[630px]:max-w-full'>
					{data.map(item => (
							<div key={item?.id} className='w-full flex items-center justify-between max-[630px]:relative'>
								<div className='max-[630px]:w-full max-[630px]:h-full max-[630px]:bg-[#000]/50 max-[1220px]:px-[20px] max-[630px]:z-20'>
								...
								<img
									src={item?.image}
									alt={item?.alt}
									className='max-w-[500px] max-[948px]:max-w-[300px] mt-[20px] max-[630px]:max-w-[200px] max-[630px]:absolute max-[630px]:bottom-0 max-[630px]:right-0 max-[630px]:z-[10] rounded-xl object-contain'
								/>
							</div>
					))}
			</div>
