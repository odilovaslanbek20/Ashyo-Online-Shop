							...
							>
								...
								<div className='bg-[#EBEFF3] rounded-[8px] p-[30px] m[30px] max-w-full max-h-[270px] max-[730px]:max-h-[250px] max-[500px]:max-h-[200px] h-full relative flex items-center justify-center'>
									<div
										...
										className='max-[800px]:w-[50px] max-[800px]:h-[50px] w-[60px] h-[60px] top-[20px] right-[20px] absolute cursor-pointer rounded-full shadow-lg p-[5px] backdrop-blur-md transition-all duration-300 bg-gradient-to-br from-pink-100 flex items-center justify-center hover:scale-110 active:scale-95 hover:shadow-xl'
									>
